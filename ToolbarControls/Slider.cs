...
namespace SurfaceFiller.Components
{
    ...
    public abstract class Slider : UserControl
    {
        ...
        protected readonly TrackBar trackBar = new()
        {
            ...
            SmallChange = 1,
            LargeChange = 1,
            MaximumSize = new Size(ControlConstants.SliderWidth, ControlConstants.MinimumControlSize),
            AutoSize = false,
        ...
        {
            AutoSize = false,
            Width = ControlConstants.LabelWidth,
        ...
        protected Slider()
        {
            this.Height = ControlConstants.MinimumControlSize;
